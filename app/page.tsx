...
const branches: Person[] = [
  ...
  { name: 'Zainal Abidin', deceased: true, children: [{ name: 'Hashim', spouse: { name: 'Aminah' }, children: [{ name: 'Mohd. Khair Johari', deceased: true, children: [{ name: 'Mohd. Khalil' }, { name: 'Masitah', phone: '011-18012750' }, { name: 'Halimatun Saadiah', phone: '012-9362853' }, { name: 'Hamidah', phone: '010-4342862' }] }] }] },
