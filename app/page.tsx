...
const branches: Person[] = [
  ...
  { name: 'Hashim', spouse: { name: 'Aminah' }, children: [{ name: 'Mohd. Khair Johari', deceased: true }, { name: 'Mohd. Khalil', phone: '017-2954495' }, { name: 'Masitah', phone: '011-18012750' }, { name: 'Halimatun Saadiah', phone: '012-9362853' }, { name: 'Hamidah', phone: '010-4342862' }] },
  ...
  return (
    <main>
      <header className="site-header">
        ...
        <div className="header-detail"><UsersRound aria-hidden="true" size={17} /><span>40 ahli · 5 generasi</span></div>
      </header>
      ...
      <section className="heritage-hero" id="top">
        ...
        <p className="hero-copy">Menyusuri nama, kasih dan hubungan yang menyatukan lima generasi.</p>
